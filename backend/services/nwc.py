# This file is based on the work licensed under CC0 1.0 Universal (Public Domain Dedication)
# Source: https://github.com/supertestnet/python_nwc/blob/main/nwc.py
